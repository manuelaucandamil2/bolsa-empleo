...
export function IconPhone(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M13.8 19.3a2 2 0 0 1-2.2.5A17 17 0 0 1 4.2 12.4a2 2 0 0 1 .5-2.2l1.8-1.8a2 2 0 0 0 .4-2.3L5.8 3.5a2 2 0 0 0-2.3-.6L2 3.4C1.2 3.7.7 4.5.8 5.4a19 19 0 0 0 17.8 17.8c.9.1 1.7-.4 2-1.2l.5-1.5a2 2 0 0 0-.6-2.3l-2.6-1.9a2 2 0 0 0-2.3.4Z" />
    </svg>
  )
}
...
export function IconTooth(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 21c-1 0-1.5-3-2-5-.3-1-1 0-1.5 1-.8 1.5-2 1-2.3-.5C5.7 14 5 11 5.5 8.5 6 6 8 4 10 4c.8 0 1.5.3 2 .8.5-.5 1.2-.8 2-.8 2 0 4 2 4.5 4.5.5 2.5-.2 5.5-.7 8-.3 1.5-1.5 2-2.3.5-.5-1-1.2-2-1.5-1-.5 2-1 5-2 5Z" />
    </svg>
  )
}
...
export function IconBrain(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 3a4 4 0 0 0-4 4c-1.7.3-3 1.8-3 3.6 0 1.2.6 2.2 1.5 2.8-.3.5-.5 1.1-.5 1.6a3 3 0 0 0 3 3h.5" />
      <path d="M12 3a4 4 0 0 1 4 4c1.7.3 3 1.8 3 3.6 0 1.2-.6 2.2-1.5 2.8.3.5.5 1.1.5 1.6a3 3 0 0 1-3 3h-.5" />
      <path d="M12 3v15" />
    </svg>
  )
}
...
export function IconStethoscope(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M9 9v2a5 5 0 0 0 10 0v-1" />
